##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [3.19.2] date: [Tue Jun 27 19:34:30 CST 2023] 
##########################################################################################################################
...
CXX_SOURCES = $(filter %.cpp,$(wildcard Core/Src/*))
...
# libraries
LIBS = -lc -lm -lnosys -nostdlib -lstdc++
LIBDIR = 
